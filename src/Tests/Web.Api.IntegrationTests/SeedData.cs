...
namespace Web.Api.IntegrationTests
{
    public static class SeedData
    {
        public static void PopulateTestData(AppIdentityDbContext dbContext)
        {
            ...
            {
                Id = Guid.Parse("41532945-599e-4910-9599-0e7402017fbe"),
                UserName = "mmacneil",
        ...
        {
            var user = new User("Mark", "Macneil", Guid.Parse("41532945-599e-4910-9599-0e7402017fbe"), "mmacneil");
            user.AddRefreshToken("rB1afdEe6MWu6TyN8zm58xqt/3KWOLRAah2nHLWcboA=", Guid.NewGuid(), "127.0.0.1");
